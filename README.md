...
\<body id="top">
        ...
        <!--CONTACT ME-->
            <nav class="row header-nav-wrap">
                <ul class="header-nav">
                    ...
                    <li><a class="smoothscroll" href="#Work" title="Work">Experience</a></li>
                    <li><a class="smoothscroll" href="#services" title="Works">Services</a></li>
                    <li><a class="smoothscroll" href="#getintouch" title="Contact">Contact</a></li>
                </ul>
            </nav> <!-- end header-nav-wrap -->

            <a href="https://drive.google.com/file/d/1Th2s_9fdZxw5FAawWeRXcWqWfKbirIqX/view?usp=sharing" class="btn btn--stroke btn--small">Download CV</a>
    ...
    <!-- hero
    ================================================== -->
    <section id="hero" class="s-hero target-section" data-parallax="scroll" data-image-src="images/te.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="row hero-content">
            ...
            <div class="column large-full">
                ...
                <ul class="hero-social">
                    <li>
                        <a href="https://www.linkedin.com/in/p-ruckpoung/" title="">LinkedIn</a>
                    </li>
                    <li>
                        <a href="https://github.com/pruckpoung" title="">GitHub</a>
                    </li>
    ...
    <section id="about" class="s-about target-section">
            ...
            <div class="row">
                <div class="column large-6 medium-8 tab-full">
                    ...
                    <div class="section-intro" data-num="01" data-aos="fade-up">
                        ...
                        <h1 class="display-1">I'm a type of person who always aims for the best</h1>
                    </div>

                    <div class="profile-pic" data-aos="fade-up">
                        <img src="images/profile-pic.jpg" 
                             srcset="images/propic.jpg 1x, images/propic.jpg 2x" alt="">
                    </div>

                    <h3 data-aos="fade-up">ABOUT ME</h3>

                    <p data-aos="fade-up">
                    Hi, my name is Puthimon Ruckpoung, please feel free to call me Patty. I am a recent graduate with M.S. in Business
                    Analytics from Suffolk University.

                    Since I was young, I have always enjoyed solving puzzles and challenging questions. So that's why I have a passion
                    for the data--it's challenging and requires detail-oriented. Delivering a big picture with a small detail 
                    is always important.  
                    </p>
        ...
        <section id="Work" class="s-about_worksection">
                ...
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Math Mahazine</span>
                                <span class="position__pos">Data Analyst Intern</span>
                            </h6>
                        ...
                        <p>
                        Provided a depth market analysis, resulting in a 15.5% increase in sales and subscriptions,
                        and analyzed custumer engagement and increased site visit 11.6% as a result.
                        </p>
                    </div>
                </div> <!-- end column -->
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Suffolk University</span>
                                <span class="position__pos">Tutor in Business Analytics classes</span>
                            </h6>
                            <div class="position__timeframe">
                                Jan 2021 - Dec 2021
                            </div>
                        ...
                        <p>
                        Held one-on-one appointments with students offering help with SQL, Python, Excel, SAS, Statistics, etc.
                        and led a weekly group discussion to help students with the Data Management and Modeling class.
                        </p>
                    </div>
                </div> <!-- end column -->
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Spot Easy Company</span>
                                <span class="position__pos">Data Analytics Project</span>
                            </h6>
                            <div class="position__timeframe">
                                Jun 2021 - Jul 2021
                            </div>
                        ...
                        <p>
                        Analyzed site traffic, interpreted relationships, interpreted trends and patterns in complex datasets, analyzed
                        Reported visualizations of business insights and relationships of prices and real estate conditions.
                        </p>
                    </div>
            </div> <!-- work positions -->
            <div class="column" data-aos="fade-up">
                <div class="position">
                    <div class="position__header">
                        <h6>
                            <span class="position__co">Red Sox</span>
                            <span class="position__pos">Data Analytics Project</span>
                        </h6>
                        <div class="position__timeframe">
                            Nov 2021 - Dec 2021
                    ...
                    <p>
                    Analyzed customer's demographic and in-depth analysis on ticket sales--the factors that affect the ticket sales, and performed 
                    visualizations on descriptive data and regression models on predictive and prescriptive analysis.
        ...
        <div class="row s-services__content">
            ...
            <div class="column large-6 s-services__leftcol">
                <div class="section-intro" data-num="02" data-aos="fade-up">
                    ...
                    <h1 class="display-1">
                    I focus on crafting business analytics experiences
                    
                    </h1>
                </div>

                <p class="lead" data-aos="fade-up">
                Analyzing the insights and making a decision is challenging. That's why I love to work in this field--it 
                helps me improve myself every day with details-oriented skills, fast learning skills, adapting to situations, etc.
                ...
                <ul class="services-list" data-aos="fade-up">
                    ...
                    <li class="services-list__item">
                        ...
                        <div class="services-list__item-body">
                            <p>
                            I use SQL constantly to communicate with the database--modify, organize, update, retrieve, and query data contained 
                    ...
                    <li class="services-list__item">
                        <div class="services-list__item-header">
                            <h5>Math, Probability, and Statistics</h5>
                        </div>
                        <div class="services-list__item-body">
                            <p>
                            My understanding of Probability and Statistics helps me detect patterns in data, avoid distortions, inconsistencies, and 
                            logical errors in your assessment, and produce accurate and consistent outcomes.
                            </p>
                        </div>
                    </li> <!-- services-list__item -->
                    <li class="services-list__item">
                        ...
                        <div class="services-list__item-body">
                            <p>
                            I use Python to clean, analyze, display massive data sets more effectively, and perform data analysis and 
                            data visualization.
                            </p>
                        </div>
                    </li> <!-- services-list__item -->
                    <li class="services-list__item">
                        ...
                        <div class="services-list__item-body">
                            <p>
                            Tableau and Power BI take a huge role on making easy-to-understand reports by using charts, graphs, 
                            and many other visual representations of data
                            </p>
                        </div>
                    </li> <!-- services-list__item -->
                    <li class="services-list__item">
                        ...
                        <div class="services-list__item-body">
                            <p>
                                Based on my experience, a critical thinking skill is required to study a situation, 
                                outlining the issues, weighing the choices, findings, and solutions.
                            </p>
                        </div>
                    </li> <!-- services-list__item -->
        ...
        <div class="row s-footer__main">
            <div class="column large-6">
                <div class="section-intro" data-aos="fade-up">
                    ...
                    Let's me serve your business. Feel free to send me a message.
                    </h1>
                </div>

                <div class="footer-email-us">
                    <a href="mailto:puthimon.r@gmail.com" class="btn btn--primary h-full-width">CONTACT ME</a>
                </div>
            </div>
                ...
                <div class="footer-contacts">
                    <div class="footer-contact-block" data-aos="fade-up">
                        ...
                        <p class="footer-contact-block__content">
                            <a href="mailto:puthimon.r@gmail.com">Email</a>
                        </p>
                    ...
                    <div class="footer-contact-block" data-aos="fade-up">
                        ...
                        <p class="footer-contact-block__content">
                            <a href="tel:+1975432345">+1(617)-602-3488</a>
                        </p>
                    </div> <!-- end footer-contact-block -->
                    <br>
                    <div class="footer-contact-block" data-aos="fade-up">
                        ...
                        <ul class="footer-contact-block__list">
                            <li><a href="https://www.linkedin.com/in/p-ruckpoung/">LinkedIn</a></li>
                            <li><a href="https://github.com/pruckpoung">GitHub</a></li>
